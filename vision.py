...
GOAL_MINIMUM_AREA = 280   #The smallest number of pixel area that a goal should be
...
GOAL_CENTER_ERROR = 3       #Allowable error from center, in pixels.
...
TURN_MIN_RATE = 0.7      #Slowest turn rate allowed
